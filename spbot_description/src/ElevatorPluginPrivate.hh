...
////////////////////////////////////////////////////////////////////////////////
  ...
  public: class ButtonState :public State
  {
  ros::Publisher _elevator_state_pub;
  std::stringstream _bs;
  int prev;
  std_msgs::String _elevator_msg;
  //Documentation inherited
  public: virtual bool Update();
  }
    ...
    ////\brief Pointer to the update model ConnectionPtr  //for elevator button perpose
    public: event::ConnectionPtr model;
