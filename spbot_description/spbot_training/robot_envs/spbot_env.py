...
class SpbotEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        * /scan: Laser Readings
        ...
        Args:
        """
        rospy.logdebug("Start SpbotEnv INIT...")
        ...
        super(SpbotEnv, self).__init__(controllers_list=self.controllers_list,
        ...
        rospy.logdebug("Finished SpbotEnv INIT...")
    ...
    def move_base(self, linear_speed, angular_speed, epsilon=0.05, update_rate=10):
        ...
        rospy.logdebug("Spbot Base Twist Cmd>>" + str(cmd_vel_value))
        self._check_publishers_connection()
    ...
    def wait_until_twist_achieved(self, cmd_vel_value, epsilon, update_rate):
        ...
        while not rospy.is_shutdown():
            ...
            # IN spbot the odometry angular readings are inverted, so we have to invert the sign.
